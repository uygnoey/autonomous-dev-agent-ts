 ...
 */
export async function readTemplateSourceFile(template: DocumentTemplate, logger: Logger): Promise<string> {
...
export async function integrateWithOptions(
  ...
  collectFragmentsFn: (projectId: string, pattern: string) => Promise<Result<readonly DocumentFragment[], Layer3Error>>,
